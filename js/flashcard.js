...
export const BADGES = [
  ...
  {id:'combo30',        icon:'🌪️', name:'Không thể ngăn cản',  desc:'Đúng 30 từ liên tiếp',             check:(u)=>u.bestCombo>=30},
  {id:'combo50',        icon:'🦄', name:'Huyền thoại sống',   desc:'Đúng 50 từ liên tiếp',             check:(u)=>u.bestCombo>=50},
  ...
  {id:'correct2000',    icon:'📖', name:'Chuyên gia từ vựng', desc:'Tổng cộng đúng 2000 từ',           check:(u)=>u.totalCorrect>=2000},
  {id:'correct5000',    icon:'🎓', name:'Bậc thầy TOEIC',     desc:'Tổng cộng đúng 5000 từ',           check:(u)=>u.totalCorrect>=5000},
  ...
  {id:'streak14',       icon:'🌟', name:'Nửa tháng bền bỉ',   desc:'Streak 14 ngày liên tiếp',         check:(u)=>u.streak>=14},
  {id:'streak30',       icon:'👑', name:'Kiên trì vô địch',   desc:'Streak 30 ngày liên tiếp',         check:(u)=>u.streak>=30},
  {id:'streak60',       icon:'💎', name:'Hai tháng kiên định', desc:'Streak 60 ngày liên tiếp',        check:(u)=>u.streak>=60},
  {id:'streak100',      icon:'🌠', name:'Trăm ngày huyền thoại', desc:'Streak 100 ngày liên tiếp',     check:(u)=>u.streak>=100},
  {id:'streak200',      icon:'⚔️', name:'Chiến binh không nghỉ', desc:'Streak 200 ngày liên tiếp',     check:(u)=>u.streak>=200},
  {id:'streak365',      icon:'🎖️', name:'Một năm chinh phục',  desc:'Streak 365 ngày liên tiếp',       check:(u)=>u.streak>=365},
